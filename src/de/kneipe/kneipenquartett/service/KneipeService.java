...
public class KneipeService extends Service {
	...
	public class KneipeServiceBinder extends Binder {
		...
		public List<Kneipe> initKneipen()
		{
			...
			Kneipe k1 = new Kneipe(101,"Marktlücke","Zähringerstrasse 96","www.karlsruhermarktluecke.de","Marktplatz","Kneipe,Bar,Club",3.40,80,2009,"TV,Essen,DJ",49.008956,8.403489,"3.5",R.drawable.marktluecke101);
			...
			Kneipe k5 = new Kneipe(105,"Badisch Brauhaus","Stephanienstrasse 38-40","www.badisch-brauhaus.de","Europaplatz","Brauhaus",3.00,45,1999,"DJ,Essen,Raucherbereich",49.011811,8.393973,"2.7", R.drawable.badischbrauhaus105);
