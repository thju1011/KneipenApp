...
public class KneipenSucheName extends Fragment {	
	private static final String LOG_TAG = KneipenSucheName.class.getSimpleName();
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		nachnameTxt = (AutoCompleteTextView) view.findViewById(R.id.name_auto);
	...
	private void suchen(View view) {
		...
		if (TextUtils.isEmpty(nachname)) {
			nachnameTxt.setError(getString(R.string.k_name_fehlt));
    		return;
    	}
		final Main mainActivity = (Main) getActivity();
		final HttpResponse<Kneipe> result = mainActivity.getKundeServiceBinder().sucheKundenByNachname(nachname, ctx);

		if (result.responseCode == HTTP_NOT_FOUND) {
			final String msg = getString(R.string.k_kneipe_not_found, nachname);
		...
		final Intent intent = new Intent(mainActivity, KneipenListe.class);
