...
public class MapActivity extends Activity{
	    ...
	    public void kneipenEinzeichen(){
	    	 ...
	    	 kneipenArray = initKneipen();
		    	...
		    	for(Kneipe k : kneipenArray){
		    		...
		    		double latitude = k.longitude;
		    		double longitude = k.latitude;
	...
	googleMap.animateCamera(CameraUpdateFactory.newCameraPosition(cameraPosition));
	    ...
	    public List<Kneipe> initKneipen()
		{
			...
			Kneipe k11 = new Kneipe(111,"App Club","Kaiserpassage 6","www.app-club.de","Europaplatz","Club",3.50,50,2010,"DJ",49.010282,8.397324);
